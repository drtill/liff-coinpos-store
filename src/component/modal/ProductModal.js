...
const ProductModal = ({ modalOpen, setModalOpen, product, cartQty }) => {
      ...
      <div className="inline-block overflow-y-auto h-full align-middle transition-all transform bg-white shadow-xl rounded-2xl">
        <div className="flex flex-col lg:flex-row md:flex-row w-full max-w-4xl overflow-hidden">
          ...
          <div className="w-full flex flex-col p-5 md:p-8 text-left">
            ...
            <div className="flex items-center mt-4">
              {cartQuantity === undefined || cartQuantity === null || cartQuantity === 0 ?
                ...
                <div className="flex items-center justify-between space-s-3 sm:space-s-4 w-full">
                  <div className="group flex items-center justify-between rounded-md overflow-hidden flex-shrink-0 border h-11 md:h-12 border-gray-300 bg-cyan-500 text-white">
                    ...
                    <button
                      onClick={() => handleCartQty(cartQuantity + 1)}
                      disabled={
                        product.quantity < cartQuantity || product.quantity === cartQuantity
                      }
                      className="flex items-center justify-center h-full flex-shrink-0 transition ease-in-out duration-300 focus:outline-none w-8 md:w-12 text-heading border-s border-gray-300 hover:text-gray-500"
                    >
                      <span className="text-dark text-base">
