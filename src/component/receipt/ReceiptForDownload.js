      ...
      <Document>
        ...
        <View style={styles.receiptFirst}>
          ...
          <View style={styles.receiptSecond}>
            ...
            <View>
              <Text style={styles.title}>หมายเลขใบเสร็จรับเงิน</Text>
          ...
          <View style={styles.paymentTable}>
            <View style={styles.orderDetailHeaderTableRow}>
              <View style={styles.paymentMethodHeaderTableCol}>
                <Text style={styles.orderDetailTableCell}>
                  <span style={styles.orderDetailHeader}>วิธีการชำระเงิน </span>
                </Text>
              </View>
              <View style={styles.approvedByHeaderTableCol}>
                <Text style={styles.orderDetailTableCell}>
                  <span style={styles.orderDetailHeader}>ผู้รับเงิน/อนุมัติโดย</span>
                </Text>
              </View>
              <View style={styles.dueDateHeaderTableCol}>
                <Text style={styles.orderDetailTableCell}>
                  <span style={styles.orderDetailHeader}>กำหนดชำระเงิน  </span>
                </Text>
              </View>
              <View style={styles.payAmountHeaderTableCol}>
                <Text style={styles.orderDetailTableCell}>
                  <span style={styles.orderDetailHeader}>ยอดที่ชำระ  </span>
                </Text>
              </View>
